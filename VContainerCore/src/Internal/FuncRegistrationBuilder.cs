...
{
    internal struct FuncRegistrationBuilder : IRegistrationBuilder
    {
        private readonly Func<IObjectResolver, object> _implementationProvider;
        ...
        {
            var spawner = new FuncInstanceProvider(_implementationProvider);
